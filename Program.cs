...
namespace labs
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            // неявно типизированные переменные для хранения массив и строки
            ...
            var (date1, word1, letter, word2, number) = tuple;
            date1 = 12;
            word1 = "qwe";
            letter = 'B';
            word2 = "ewq";
            number = 11;
            (date1, word1, letter, word2, number) = tuple;
            (_, _, _, word2, number) = tuple;
            ...
            // Локальная функция
            (int max, int min, int sum, string letter) function(int[] arr, string st)
            {
